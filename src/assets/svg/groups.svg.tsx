...
export const GroupsSvg: React.FC<BoxProps> = ({ sx, ...other }) => {
  const theme = useTheme();
  const PRIMARY_MAIN = theme.palette.grey[500];
  const PRIMARY_DARK = theme.palette.grey[700];
  const PRIMARY_DARKER = theme.palette.grey[900];
  return (
    <Box {...other} sx={{ ...sx, pr: 8 }}>
      <svg
