...
export const PostsSvg: React.FC<BoxProps> = ({ ...other }) => {
  const theme = useTheme();
  const PRIMARY_LIGHTER = theme.palette.secondary.dark;
  const PRIMARY_MAIN = theme.palette.grey['A200'];
  const PRIMARY_DARK = theme.palette.grey[800];
  const PRIMARY_DARKER = theme.palette.secondary.dark;
  return (
    <Box {...other}>
